...
\newcommand{\statusimage}[1]{%
  \ifthenelse{\equal{#1}{pass}}%
    {\centering\includegraphics[width=.6cm, height=.6cm]{green-circle.png}}%
    {\ifthenelse{\equal{#1}{warn}}%
      {\centering\includegraphics[width=.6cm, height=.6cm]{yellow-circle.png}}%
      {\ifthenelse{\equal{#1}{fail}}%
        {\centering\includegraphics[width=.6cm, height=.6cm]{red-circle.png}}%
        {\ifthenelse{\equal{#1}{ignore}}%
          {\centering\includegraphics[width=.6cm, height=.6cm]{white-circle.png}}%
          {\centering #1}%
        }%
      }%
    }%
